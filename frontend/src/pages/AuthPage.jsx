...
export default function AuthPage() {
  ...
  return (
    <div className="auth-page-container">
      <div className="auth-card glass-card fade-up" style={{ '--delay': '0s' }}>
        ...
        {!error && (
          <p style={{ marginTop: '12px', marginBottom: '0', color: 'var(--sage)', fontSize: '12px' }}>
            Backend API: {API_URL}
          </p>
        )}
        ...
        <button className="github-oauth-btn" type="button" onClick={handleGithubOAuth}>
